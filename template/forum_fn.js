...
function parseDocument($container) {
	...
	* Pagination
	*/
	$container.find('.total-posts-container .page-jump-form :button').click(function() {
		var $input = $(this).parent().siblings('input.form-control');
		pageJump($input);
	});

	$container.find('.total-posts-container .page-jump-form input.form-control').on('keypress', function(event) {
	...
	$container.find('.total-posts-container .dropdown-toggle').click(function() {
